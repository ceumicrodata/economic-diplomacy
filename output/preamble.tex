\documentclass[compress,mathserif,aspectratio=54]{beamer}
...
\title{Trade policy differences across\\ EU Member States}

\author {Miklós Koren (CEU, CERS and CEPR)\\
with: Gábor Berei, Matteo Fiorini,\\ Filippo Santi and Gergő Závecz}
...
{\footnotesize Research supported by H2020/RESPECT}
...
\pgfdeclareimage[height=0.5cm]{university-logo}{Respect-logoweb.jpg}
...
\setbeamertemplate{footline}{\insertframenumber\hfill{}}
