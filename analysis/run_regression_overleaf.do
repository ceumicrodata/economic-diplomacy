...
forval i=90(5)95 {
	coefplot all_intent_both_1 all_intent_both_2 all_intent_both_3 all_intent_both_4, bylabel("All countries") || eu_intent_both_1 eu_intent_both_2 eu_intent_both_3 eu_intent_both_4, bylabel("EU countries") || neighbor_intent_both_1 neighbor_intent_both_2 neighbor_intent_both_3 neighbor_intent_both_4, bylabel("Neighboorhood countries") || (other_intent_both_1, mcolor(green) ciopts(color(green))) (other_intent_both_2, mcolor(red) ciopts(color(red))) (other_intent_both_3, mcolor(blue) ciopts(color(blue))) (other_intent_both_4, mcolor(orange) ciopts(color(orange))), bylabel("Other countries") ||, keep(p p_inv) coeflabel(p = "Trade" p_inv = "Investment") xline(0, lcolor(black)) subtitle(, lcolor(white) fcolor(white)) levels(`i') xscale(range(-2 1)) plotlabels("Without FE without political" "Without FE with political" "With FE without political" "With FE with political") byopts(graphregion(col(white)) bgcol(white) title("Intent", color(black)))
	graph export "output/coefficients_intent_both_all_`i'.png", replace

	coefplot all_visits_both_1 all_visits_both_2 all_visits_both_3 all_visits_both_4, bylabel("All countries") || eu_visits_both_1 eu_visits_both_2 eu_visits_both_3 eu_visits_both_4, bylabel("EU countries") || neighbor_visits_both_1 neighbor_visits_both_2 neighbor_visits_both_3 neighbor_visits_both_4, bylabel("Neighboorhood countries") || (other_visits_both_1, mcolor(green) ciopts(color(green))) (other_visits_both_2, mcolor(red) ciopts(color(red))) (other_visits_both_3, mcolor(blue) ciopts(color(blue))) (other_visits_both_4, mcolor(orange) ciopts(color(orange))), bylabel("Other countries") ||, keep(p p_inv) coeflabel(p = "Trade" p_inv = "Investment") xline(0, lcolor(black)) subtitle(, lcolor(white) fcolor(white)) levels(`i') xscale(range(-2 1)) plotlabels("Without FE without political" "Without FE with political" "With FE without political" "With FE with political") byopts(graphregion(col(white)) bgcol(white) title("Visits", color(black)))
	graph export "output/coefficients_visits_both_all_`i'.png", replace

	coefplot all_intent_both_1 all_intent_both_2, bylabel("All countries") || eu_intent_both_1 eu_intent_both_2, bylabel("EU countries") || neighbor_intent_both_1 neighbor_intent_both_2, bylabel("Neighboorhood countries") || (other_intent_both_1, mcolor(green) ciopts(color(green))) (other_intent_both_2, mcolor(red) ciopts(color(red))), bylabel("Other countries") ||, keep(p p_inv) coeflabel(p = "Trade" p_inv = "Investment") xline(0, lcolor(black)) subtitle(, lcolor(white) fcolor(white)) levels(`i') xscale(range(-2 1)) plotlabels("Without political" "With political") byopts(graphregion(col(white)) bgcol(white) title("Intent - without FE", color(black)))
	graph export "output/coefficients_intent_both_all_wofe_`i'.png", replace

	coefplot all_visits_both_1 all_visits_both_2, bylabel("All countries") || eu_visits_both_1 eu_visits_both_2, bylabel("EU countries") || neighbor_visits_both_1 neighbor_visits_both_2, bylabel("Neighboorhood countries") || (other_visits_both_1, mcolor(green) ciopts(color(green))) (other_visits_both_2, mcolor(red) ciopts(color(red))), bylabel("Other countries") ||, keep(p p_inv) coeflabel(p = "Trade" p_inv = "Investment") xline(0, lcolor(black)) subtitle(, lcolor(white) fcolor(white)) levels(`i') xscale(range(-2 1)) plotlabels("Without political" "With political") byopts(graphregion(col(white)) bgcol(white) title("Visits - without FE", color(black)))
	graph export "output/coefficients_visits_both_all_wofe_`i'.png", replace

	coefplot all_intent_both_3 all_intent_both_4, bylabel("All countries") || eu_intent_both_3 eu_intent_both_4, bylabel("EU countries") || neighbor_intent_both_3 neighbor_intent_both_4, bylabel("Neighboorhood countries") || (other_intent_both_3, mcolor(green) ciopts(color(green))) (other_intent_both_4, mcolor(red) ciopts(color(red))), bylabel("Other countries") ||, keep(p p_inv) coeflabel(p = "Trade" p_inv = "Investment") xline(0, lcolor(black)) subtitle(, lcolor(white) fcolor(white)) levels(`i') xscale(range(-2 1)) plotlabels("Without political" "With political") byopts(graphregion(col(white)) bgcol(white) title("Intent - with FE", color(black)))
	graph export "output/coefficients_intent_both_all_fe_`i'.png", replace

	coefplot all_visits_both_3 all_visits_both_4, bylabel("All countries") || eu_visits_both_3 eu_visits_both_4, bylabel("EU countries") || neighbor_visits_both_3 neighbor_visits_both_4, bylabel("Neighboorhood countries") || (other_visits_both_3, mcolor(green) ciopts(color(green))) (other_visits_both_4, mcolor(red) ciopts(color(red))), bylabel("Other countries") ||, keep(p p_inv) coeflabel(p = "Trade" p_inv = "Investment") xline(0, lcolor(black)) subtitle(, lcolor(white) fcolor(white)) levels(`i') xscale(range(-2 1)) plotlabels("Without political" "With political") byopts(graphregion(col(white)) bgcol(white) title("Visits - with FE", color(black)))
	graph export "output/coefficients_visits_both_all_fe_`i'.png", replace
}
